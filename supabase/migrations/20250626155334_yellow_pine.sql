/*
  ...
  1. Sample Data Tables
    - Populate sample_datasets with realistic business data
    - Populate sample_kpis with performance indicators
    - Populate sample_dashboards with dashboard configurations
    - Populate sample_portfolios with investment portfolios

  2. Helper Functions
    - Create function to copy sample data to user accounts
    - Update user registration trigger to include sample data

  3. Data Quality
    - Comprehensive sample datasets for immediate exploration
    - Realistic KPIs across different business categories
    - Multiple dashboard layouts and widget configurations
    - Diverse portfolio types (growth, balanced, dividend)
*/
